...
class Mtender extends Mcrud_ext
{
    protected static $TABLE_NAME = "tcg_tender";
    protected static $PRIMARY_KEY = "tenderid";
    protected static $COLUMNS = array();
    protected static $FILTERS = array();

    protected static $COL_LABEL = 'tendernum';
    protected static $COL_VALUE = 'tenderid';
    ...
    function list($filter = null, $limit = null, $offset = null, $orderby = null) {
        ...
        $this->db->select("f.contractnum as contractid_label, g.nama as closedby_label");
        //$this->db->from("tcg_tender a");
        ...
        $arr = $this->db->get("tcg_tender a", $limit, $offset)->result_array();
    ...
    function lookup($filter = null) {
        ...
        //build query
        $this->db->select("a.tenderid as value, a.tendernum as label");
        ...
        $arr = $this->db->get("tcg_tender a")->result_array();
        if ($arr == null)       return $arr;
    ...
    function add($valuepair, $enforce_edit_columns = true) {
        ...
        $valuepair['status'] = 'INPROG';

        //default
        if (empty($valuepair['tendernum'])) {
            $valuepair['tendernum'] = 'TE0000';
        }
        ...
        if ($id > 0) {
            ...
            $this->db->query("call usp_tender_dataconsistency(?,?)", array($id,$pengguna_id));
        }
