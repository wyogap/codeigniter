			...
			<table id="renbut" class="table table-striped dt-responsive nowrap" width="100%">
				<thead>
					<tr>
						...
						<th class="text-center" data-priority="1">Kekurangan</th>
					</tr>
				</thead>
			</table>
		</div>			
...
<div class="row">
	<div class="col-12 col-sm-12 col-md-6 col-xl-4">
		<div class="card widget-inline">
			<div class="card-header">Rencana Kebutuhan</div>
			<div class="card-body">
			<div class="row">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="table-responsive-sm">
						<table id="renbut" class="table table-striped dt-responsive nowrap" width="100%">
							<thead>
								<tr>
									<th class="text-center" data-priority="1">No. Renbut</th>
	...
	<div class="col-12 col-sm-12">	
		<div class="card">
			<div class="card-header with-border text-center">
				<span class="box-title"><b>Profil Kebutuhan</b></span>
			</div>
			<div class="card-body">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
