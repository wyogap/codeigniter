...
<head>
    <title>Check-In Berhasil | Induk Warga Asal Kabupaten Kebumen</title>
    <!-- all the meta tags -->
        ...
        <div class="" style="min-height: 644px;">
            ...
            <div class="content" style="padding: 0px 0.5rem;">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card widget-inline">
                                <div class="card-body">
                                    <div class="row"><div class="col-6 col-lg-4">No. Registrasi:</div><div class="col-6 col-lg-8">xxx</div></div>
                                    <div class="row"><div class="col-6 col-lg-4">Nama Lengkap:</div><div class="col-6 col-lg-8">xxx</div></div>
                                    <div class="row"><div class="col-6 col-lg-4">No. KTP:</div><div class="col-6 col-lg-8">xxx</div></div>
                                    <div class="row"><div class="col-6 col-lg-4">No. HP:</div><div class="col-6 col-lg-8">xxx</div></div>
                                </div>
                            </div>
                            <!-- </form> -->
                        </div> <!-- end col -->
                    ...
                    <div class="row">
                        <div class="col-12">
                                <button class="btn btn-primary crud-form-submit" style="width: 100%;">CHECK-IN LAGI</button>
                            </div>
                            <!-- </form> -->
                        </div> <!-- end col -->
                    </div>
            ...
            <script type="text/javascript" defer>
                ...
                $(document).ready(function() {
                    ...
                    let form_container = $('#tdata_74_form');
                    let form_container2 = $('#tdata_75_form');
                    // let val = null;
                    ...
                    edit_list.forEach(function(conf, index, arr) {
                        ...
                        if (conf.idx=="1")  form_container.append(dom);
                        else    form_container2.append(dom);
