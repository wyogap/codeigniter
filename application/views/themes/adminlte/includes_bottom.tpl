...
<!-- app -->
<script src="{$base_url}{$theme_prefix}/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js" defer></script>
<script src="{$base_url}{$theme_prefix}/dist/js/adminlte.min.js" defer></script>
