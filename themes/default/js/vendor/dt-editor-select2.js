(function ($, DataTable) {
	...
	_fieldTypes.tcg_select2 = {
		...
		create: function (conf) {
			...
			// $('select', conf._input).click( function () {
			//     if ( conf._enabled ) {
			...
			// if (typeof conf.attr.minimumResultsForSearch === 'undefined' || conf.attr.minimumResultsForSearch == null) {
			// 	conf.attr.minimumResultsForSearch = tcg_select2.defaults.minimumResultsForSearch;
			// }

			// if (typeof conf.attr.select2 === 'undefined') {
			// 	conf.attr.select2 = tcg_select2.defaults.select2;
			// }
